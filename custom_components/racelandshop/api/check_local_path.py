...
from custom_components.racelandshop.helpers.functions.path_exsist import async_path_exsist


@websocket_api.async_response
@websocket_api.websocket_command(
    {vol.Required("type"): "racelandshop/check_path", vol.Optional("path"): cv.string}
)
