"""API Handler for racelandshop_repositories"""
...
@websocket_api.websocket_command({vol.Required("type"): "racelandshop/repositories"})
async def racelandshop_repositories(_hass, connection, msg):
    """Handle get media player cover command."""
    racelandshop = get_racelandshop()
    repositories = racelandshop.repositories
    content = []
    for repo in repositories:
        if repo.data.category in racelandshop.common.categories:
            data = {
