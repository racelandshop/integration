"""Class for appdaemon apps in RACELANDSHOP."""
...
class RacelandshopAppdaemon(RacelandshopRepository):
    """Appdaemon apps in RACELANDSHOP."""
    ...
    def __init__(self, full_name):
        ...
        self.data.category = RacelandshopCategory.APPDAEMON
    ...
    def localpath(self):
        """Return localpath."""
        return f"{self.racelandshop.core.config_path}/appdaemon/apps/{self.data.name}"
