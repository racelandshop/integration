...
PROJECT_URL = "https://github.com/racelandshop/integration/"
...
PACKAGE_NAME = "custom_components.racelandshop"

RACELANDSHOP_GITHUB_API_HEADERS = {
    "User-Agent": f"RACELANDSHOP/{INTEGRATION_VERSION}",
    "Accept": ACCEPT_HEADERS["preview"],
}

RACELANDSHOP_ACTION_GITHUB_API_HEADERS = {
    "User-Agent": "RACELANDSHOP/action",
    "Accept": ACCEPT_HEADERS["preview"],
}

IFRAME = {
    "title": "RACELANDSHOP",
    "icon": "racelandshop:racelandshop",
...
STARTUP = f"""
-------------------------------------------------------------------
RACELANDSHOP (Home Assistant Community Store)

Version: {INTEGRATION_VERSION}
This is a custom integration
If you have any issues with this you need to open an issue here:
https://github.com/racelandshop/integration/issues
-------------------------------------------------------------------
"""
