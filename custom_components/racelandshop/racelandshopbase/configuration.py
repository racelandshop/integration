...
class Configuration:
    ...
    sidepanel_icon: str = "racelandshop:racelandshop"
    sidepanel_title: str = "RACELANDSHOP"
    ...
    def from_dict(configuration: dict, options: dict = None) -> None:
        ...
        if isinstance(options, bool) or isinstance(configuration.get("options"), bool):
            raise RacelandshopException("Configuration is not valid.")
