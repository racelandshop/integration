...
def test_racelandshop_repository_core_mostly_defaults():
...
def test_racelandshop_repository_core_can_install_legacy():
    repository = RacelandshopRepository()
    repository.racelandshop.system.ha_version = "1.0.0"
...
def test_racelandshop_repository_core_can_install_manifest():
    repository = RacelandshopRepository()
    repository.racelandshop.system.ha_version = "1.0.0"
    repository.data.releases = True
