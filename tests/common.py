...
def dummy_repository_base(racelandshop, repository=None):
    if repository is None:
        repository = RacelandshopRepository()
    repository.racelandshop = racelandshop
    repository.racelandshop.hass = racelandshop.hass
    repository.racelandshop.core.config_path = racelandshop.hass.config.path()
