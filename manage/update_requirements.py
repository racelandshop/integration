...
with open(f"{os.getcwd()}/custom_components/racelandshop/manifest.json") as manifest:
...
with open(f"{os.getcwd()}/custom_components/racelandshop/manifest.json", "w") as manifestfile:
